...
const Place2 = () => {
    ...
    const slides = [
      {
        url: 'https://www.tourmyindia.com/blog//wp-content/uploads/2018/06/Historical-Sites-in-Jaipur.jpg',
      },
      {
        url: 'https://static.india.com/wp-content/uploads/2021/08/Jaipur-1200.jpg?impolicy=Medium_Resize&w=1200&h=800',
      },
      {
        url: 'https://jaipurtourism.co.in/images/places-to-visit/header/jaipur-local-sightseeing-tour-packages-with-price-and-itinerary-places-tourism-entry-fee-timings-holidays-reviews-header.jpg',
      },
  
      {
        url: 'https://www.tourmyindia.com/blog//wp-content/uploads/2020/11/Amer-fort-jaipur-feature.jpg',
      },
      {
        url: 'https://www.fabhotels.com/blog/wp-content/uploads/2019/03/Galtaji-Temple.jpg',
      },
    ];
  ...
  <div className='w-[100%] h-10 mx-auto'>
        <h1 className='font-bold text-2xl sm:text-4xl px-6 pt-10 mt-0'>Explore Jaipur </h1>
        </div>
      ...
      <img
            className="relative z-30 object-cover inline-block h-10 w-10 rounded-full ring-2 ring-white"
            src="https://th.bing.com/th/id/OIP.GmOfJmqsZZpuIkKVkRFbEgHaLH?rs=1&pid=ImgDetMain"
            alt="Dan_Abromov"
          />
          <img
            className="relative z-20 object-cover inline-block h-10 w-10 rounded-full ring-2 ring-white"
            src="https://i.pinimg.com/736x/b8/ee/d4/b8eed48b2b652b7c74aad0da955dd9e7.jpg"
            alt="Guillermo_Rauch"
          />
          <img
            className="relative z-10 object-cover inline-block h-10 w-10 rounded-full ring-2 ring-white"
      ...
      <h1 className='font-semibold px-4'>This private tour can be <span className='text-pink-700'>100%</span> personalized for you</h1>
        ...
        <div className="isolate flex -space-x-8 pt-4 px-4 pb-4">
          <img
            className="relative object-cover z-20 inline-block h-20 w-20 rounded-full ring-2 ring-white"
            src="https://i.pinimg.com/736x/b8/ee/d4/b8eed48b2b652b7c74aad0da955dd9e7.jpg"
            alt="Dan_Abromov"
          />
          <img
            className="relative z-20 object-cover inline-block h-20 w-20 rounded-full ring-2 ring-white"
            src="https://th.bing.com/th/id/OIP.GmOfJmqsZZpuIkKVkRFbEgHaLH?rs=1&pid=ImgDetMain"
            alt="Guillermo_Rauch"
          />
          <img
